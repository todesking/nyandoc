# com.todesking.dox.Markup$$DlItem
...
* Implicit information
  * This member is added by an implicit conversion from DlItem to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from DlItem to ArrowAssoc [
    DlItem] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(DlItem,B))


 `def ensuring(cond: (DlItem) ⇒ Boolean): DlItem`
--------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from DlItem to Ensuring [
    DlItem] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((DlItem)⇒Boolean):DlItem)


 `def ensuring(cond: (DlItem) ⇒ Boolean, msg: ⇒ Any): DlItem`
--------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((DlItem)⇒Boolean,⇒Any):DlItem)


 `def ensuring(cond: Boolean): DlItem`
---------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):DlItem)


 `def ensuring(cond: Boolean, msg: ⇒ Any): DlItem`
---------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):DlItem)
...
* Implicit information
  * This member is added by an implicit conversion from DlItem to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:DlItem)
