# com.todesking.dox.Markup$$ListItem
...
* Implicit information
  * This member is added by an implicit conversion from ListItem to StringAdd
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (ListItem, B)`
----------------------------------

* Implicit information
  * This member is added by an implicit conversion from ListItem to ArrowAssoc [
    ListItem] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(ListItem,B))


 `def ensuring(cond: (ListItem) ⇒ Boolean): ListItem`
------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ListItem to Ensuring [
    ListItem] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ListItem)⇒Boolean):ListItem)


 `def ensuring(cond: (ListItem) ⇒ Boolean, msg: ⇒ Any): ListItem`
------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ListItem)⇒Boolean,⇒Any):ListItem)


 `def ensuring(cond: Boolean): ListItem`
-----------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):ListItem)


 `def ensuring(cond: Boolean, msg: ⇒ Any): ListItem`
-----------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):ListItem)
...
* Implicit information
  * This member is added by an implicit conversion from ListItem to StringFormat
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (listItem: ArrowAssoc[ListItem]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:ListItem)
