# com.todesking.dox.JsoupExt$$ElementsExt
...
* Implicit information
  * This member is added by an implicit conversion from ElementsExt [A] to
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (ElementsExt[A], B)`
----------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ElementsExt [A] to
    ArrowAssoc [ElementsExt [A]] performed by method any2ArrowAssoc in
    scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(ElementsExt[A],B))


 `def ensuring(cond: (ElementsExt[A]) ⇒ Boolean): ElementsExt[A]`
------------------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ElementsExt [A] to
    Ensuring [ElementsExt [A]] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ElementsExt[A])⇒Boolean):ElementsExt[A])


 `def ensuring(cond: (ElementsExt[A]) ⇒ Boolean, msg: ⇒ Any): ElementsExt[A]`
------------------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ElementsExt[A])⇒Boolean,⇒Any):ElementsExt[A])


 `def ensuring(cond: Boolean): ElementsExt[A]`
-----------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):ElementsExt[A])


 `def ensuring(cond: Boolean, msg: ⇒ Any): ElementsExt[A]`
-----------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):ElementsExt[A])
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (elementsExt: ArrowAssoc[ElementsExt[A]]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:ElementsExt[A])
