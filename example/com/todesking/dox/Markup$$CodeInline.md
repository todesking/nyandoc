# com.todesking.dox.Markup$$CodeInline
...
* Implicit information
  * This member is added by an implicit conversion from CodeInline to StringAdd
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (CodeInline, B)`
------------------------------------

* Implicit information
  * This member is added by an implicit conversion from CodeInline to ArrowAssoc
    [CodeInline] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(CodeInline,B))


 `def ensuring(cond: (CodeInline) ⇒ Boolean): CodeInline`
----------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from CodeInline to Ensuring [
    CodeInline] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((CodeInline)⇒Boolean):CodeInline)


 `def ensuring(cond: (CodeInline) ⇒ Boolean, msg: ⇒ Any): CodeInline`
----------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((CodeInline)⇒Boolean,⇒Any):CodeInline)


 `def ensuring(cond: Boolean): CodeInline`
-------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):CodeInline)


 `def ensuring(cond: Boolean, msg: ⇒ Any): CodeInline`
-------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):CodeInline)
...
* Implicit information
  * This member is added by an implicit conversion from CodeInline to
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (codeInline: ArrowAssoc[CodeInline]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:CodeInline)
