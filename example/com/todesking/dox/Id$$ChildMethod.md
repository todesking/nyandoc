...
* Implicit information
  * This member is added by an implicit conversion from ChildMethod to StringAdd
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (ChildMethod, B)`
-------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ChildMethod to
    ArrowAssoc [ChildMethod] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(ChildMethod,B))


 `def ensuring(cond: (ChildMethod) ⇒ Boolean): ChildMethod`
------------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ChildMethod to Ensuring
    [ChildMethod] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ChildMethod)⇒Boolean):ChildMethod)


 `def ensuring(cond: (ChildMethod) ⇒ Boolean, msg: ⇒ Any): ChildMethod`
------------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ChildMethod)⇒Boolean,⇒Any):ChildMethod)


 `def ensuring(cond: Boolean): ChildMethod`
--------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):ChildMethod)


 `def ensuring(cond: Boolean, msg: ⇒ Any): ChildMethod`
--------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):ChildMethod)
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (childMethod: ArrowAssoc[ChildMethod]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:ChildMethod)
