# com.todesking.dox.Markup$$Italic
...
* Implicit information
  * This member is added by an implicit conversion from Italic to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Italic to ArrowAssoc [
    Italic] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Italic,B))


 `def ensuring(cond: (Italic) ⇒ Boolean): Italic`
--------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Italic to Ensuring [
    Italic] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Italic)⇒Boolean):Italic)


 `def ensuring(cond: (Italic) ⇒ Boolean, msg: ⇒ Any): Italic`
--------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Italic)⇒Boolean,⇒Any):Italic)


 `def ensuring(cond: Boolean): Italic`
---------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Italic)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Italic`
---------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Italic)
...
* Implicit information
  * This member is added by an implicit conversion from Italic to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Italic)
