# com.todesking.dox.JsoupExt$$ElementExt
...
* Implicit information
  * This member is added by an implicit conversion from ElementExt [A] to
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (ElementExt[A], B)`
---------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ElementExt [A] to
    ArrowAssoc [ElementExt [A]] performed by method any2ArrowAssoc in
    scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(ElementExt[A],B))


 `def ensuring(cond: (ElementExt[A]) ⇒ Boolean): ElementExt[A]`
----------------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ElementExt [A] to
    Ensuring [ElementExt [A]] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ElementExt[A])⇒Boolean):ElementExt[A])


 `def ensuring(cond: (ElementExt[A]) ⇒ Boolean, msg: ⇒ Any): ElementExt[A]`
----------------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ElementExt[A])⇒Boolean,⇒Any):ElementExt[A])


 `def ensuring(cond: Boolean): ElementExt[A]`
----------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):ElementExt[A])


 `def ensuring(cond: Boolean, msg: ⇒ Any): ElementExt[A]`
----------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):ElementExt[A])
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (elementExt: ArrowAssoc[ElementExt[A]]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:ElementExt[A])
