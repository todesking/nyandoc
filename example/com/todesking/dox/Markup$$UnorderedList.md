# com.todesking.dox.Markup$$UnorderedList
...
* Implicit information
  * This member is added by an implicit conversion from UnorderedList to
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (UnorderedList, B)`
---------------------------------------

* Implicit information
  * This member is added by an implicit conversion from UnorderedList to
    ArrowAssoc [UnorderedList] performed by method any2ArrowAssoc in
    scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(UnorderedList,B))


 `def ensuring(cond: (UnorderedList) ⇒ Boolean): UnorderedList`
----------------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from UnorderedList to
    Ensuring [UnorderedList] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((UnorderedList)⇒Boolean):UnorderedList)


 `def ensuring(cond: (UnorderedList) ⇒ Boolean, msg: ⇒ Any): UnorderedList`
----------------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((UnorderedList)⇒Boolean,⇒Any):UnorderedList)


 `def ensuring(cond: Boolean): UnorderedList`
----------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):UnorderedList)


 `def ensuring(cond: Boolean, msg: ⇒ Any): UnorderedList`
----------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):UnorderedList)
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (unorderedList: ArrowAssoc[UnorderedList]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:UnorderedList)
