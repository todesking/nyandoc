# com.todesking.dox.MarkdownFormatter
...
* Implicit information
  * This member is added by an implicit conversion from MarkdownFormatter to
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (MarkdownFormatter, B)`
-------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from MarkdownFormatter to
    ArrowAssoc [MarkdownFormatter] performed by method any2ArrowAssoc in
    scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(MarkdownFormatter,B))


 `def ensuring(cond: (MarkdownFormatter) ⇒ Boolean): MarkdownFormatter`
------------------------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from MarkdownFormatter to
    Ensuring [MarkdownFormatter] performed by method any2Ensuring in
    scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((MarkdownFormatter)⇒Boolean):MarkdownFormatter)


 `def ensuring(cond: (MarkdownFormatter) ⇒ Boolean, msg: ⇒ Any): MarkdownFormatter`
------------------------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((MarkdownFormatter)⇒Boolean,⇒Any):MarkdownFormatter)


 `def ensuring(cond: Boolean): MarkdownFormatter`
--------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):MarkdownFormatter)


 `def ensuring(cond: Boolean, msg: ⇒ Any): MarkdownFormatter`
--------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):MarkdownFormatter)
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (markdownFormatter: StringAdd).self
    ```
* Definition Classes
  * StringAdd
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (markdownFormatter: ArrowAssoc[MarkdownFormatter]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:MarkdownFormatter)
