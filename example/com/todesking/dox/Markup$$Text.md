...
* Implicit information
  * This member is added by an implicit conversion from Text to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Text to ArrowAssoc [Text]
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Text,B))


 `def ensuring(cond: (Text) ⇒ Boolean): Text`
----------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Text to Ensuring [Text]
    performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Text)⇒Boolean):Text)


 `def ensuring(cond: (Text) ⇒ Boolean, msg: ⇒ Any): Text`
----------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Text)⇒Boolean,⇒Any):Text)


 `def ensuring(cond: Boolean): Text`
-------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Text)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Text`
-------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Text)
...
* Implicit information
  * This member is added by an implicit conversion from Text to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Text)
