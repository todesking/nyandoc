...
* Implicit information
  * This member is added by an implicit conversion from Scope to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Scope to ArrowAssoc [
    Scope] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Scope,B))


 `def ensuring(cond: (Scope) ⇒ Boolean): Scope`
------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Scope to Ensuring [Scope]
    performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Scope)⇒Boolean):Scope)


 `def ensuring(cond: (Scope) ⇒ Boolean, msg: ⇒ Any): Scope`
------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Scope)⇒Boolean,⇒Any):Scope)


 `def ensuring(cond: Boolean): Scope`
--------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Scope)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Scope`
--------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Scope)
...
* Implicit information
  * This member is added by an implicit conversion from Scope to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Scope)
