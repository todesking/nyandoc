...
* Implicit information
  * This member is added by an implicit conversion from ResultType to StringAdd
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (ResultType, B)`
------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ResultType to ArrowAssoc
    [ResultType] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(ResultType,B))


 `def ensuring(cond: (ResultType) ⇒ Boolean): ResultType`
----------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ResultType to Ensuring [
    ResultType] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ResultType)⇒Boolean):ResultType)


 `def ensuring(cond: (ResultType) ⇒ Boolean, msg: ⇒ Any): ResultType`
----------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ResultType)⇒Boolean,⇒Any):ResultType)


 `def ensuring(cond: Boolean): ResultType`
-------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):ResultType)


 `def ensuring(cond: Boolean, msg: ⇒ Any): ResultType`
-------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):ResultType)
...
* Implicit information
  * This member is added by an implicit conversion from ResultType to
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (resultType: ArrowAssoc[ResultType]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:ResultType)
