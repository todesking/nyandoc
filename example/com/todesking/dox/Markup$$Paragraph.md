# com.todesking.dox.Markup$$Paragraph
...
* Implicit information
  * This member is added by an implicit conversion from Paragraph to StringAdd
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (Paragraph, B)`
-----------------------------------

* Implicit information
  * This member is added by an implicit conversion from Paragraph to ArrowAssoc
    [Paragraph] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Paragraph,B))


 `def ensuring(cond: (Paragraph) ⇒ Boolean): Paragraph`
--------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Paragraph to Ensuring [
    Paragraph] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Paragraph)⇒Boolean):Paragraph)


 `def ensuring(cond: (Paragraph) ⇒ Boolean, msg: ⇒ Any): Paragraph`
--------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Paragraph)⇒Boolean,⇒Any):Paragraph)


 `def ensuring(cond: Boolean): Paragraph`
------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Paragraph)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Paragraph`
------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Paragraph)
...
* Implicit information
  * This member is added by an implicit conversion from Paragraph to
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (paragraph: ArrowAssoc[Paragraph]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Paragraph)
