...
* Implicit information
  * This member is added by an implicit conversion from Layout to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Layout to ArrowAssoc [
    Layout] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Layout,B))


 `def ensuring(cond: (Layout) ⇒ Boolean): Layout`
--------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Layout to Ensuring [
    Layout] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Layout)⇒Boolean):Layout)


 `def ensuring(cond: (Layout) ⇒ Boolean, msg: ⇒ Any): Layout`
--------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Layout)⇒Boolean,⇒Any):Layout)


 `def ensuring(cond: Boolean): Layout`
---------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Layout)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Layout`
---------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Layout)
...
* Implicit information
  * This member is added by an implicit conversion from Layout to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Layout)
