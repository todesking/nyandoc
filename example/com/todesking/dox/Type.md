...
* Implicit information
  * This member is added by an implicit conversion from Type to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Type to ArrowAssoc [Type]
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Type,B))


 `def ensuring(cond: (Type) ⇒ Boolean): Type`
----------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Type to Ensuring [Type]
    performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Type)⇒Boolean):Type)


 `def ensuring(cond: (Type) ⇒ Boolean, msg: ⇒ Any): Type`
----------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Type)⇒Boolean,⇒Any):Type)


 `def ensuring(cond: Boolean): Type`
-------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Type)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Type`
-------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Type)
...
* Implicit information
  * This member is added by an implicit conversion from Type to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Type)
