...
* Implicit information
  * This member is added by an implicit conversion from ChildType to StringAdd
...
(added by implicit convertion: scala.Predef.any2stringadd#+(String):String)
 ...
 `def ->[B](y: B): (ChildType, B)`
-----------------------------------

* Implicit information
  * This member is added by an implicit conversion from ChildType to ArrowAssoc
    [ChildType] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(ChildType,B))


 `def ensuring(cond: (ChildType) ⇒ Boolean): ChildType`
--------------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from ChildType to Ensuring [
    ChildType] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ChildType)⇒Boolean):ChildType)


 `def ensuring(cond: (ChildType) ⇒ Boolean, msg: ⇒ Any): ChildType`
--------------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((ChildType)⇒Boolean,⇒Any):ChildType)


 `def ensuring(cond: Boolean): ChildType`
------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):ChildType)


 `def ensuring(cond: Boolean, msg: ⇒ Any): ChildType`
------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):ChildType)
...
* Implicit information
  * This member is added by an implicit conversion from ChildType to
...
* Shadowing
  * This implicitly inherited member is ambiguous. One or more implicitly
    ...
    :
    ```scala
    (childType: ArrowAssoc[ChildType]).x
    ```
* Definition Classes
  * ArrowAssoc
* Annotations
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:ChildType)
