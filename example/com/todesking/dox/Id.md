...
* Implicit information
  * This member is added by an implicit conversion from Id to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Id to ArrowAssoc [Id]
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Id,B))


 `def ensuring(cond: (Id) ⇒ Boolean): Id`
------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Id to Ensuring [Id]
    performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Id)⇒Boolean):Id)


 `def ensuring(cond: (Id) ⇒ Boolean, msg: ⇒ Any): Id`
------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Id)⇒Boolean,⇒Any):Id)


 `def ensuring(cond: Boolean): Id`
-----------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Id)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Id`
-----------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Id)
...
* Implicit information
  * This member is added by an implicit conversion from Id to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Id)
