# com.todesking.dox.Scope$$Private
...
* Implicit information
  * This member is added by an implicit conversion from Private to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Private to ArrowAssoc [
    Private] performed by method any2ArrowAssoc in scala.Predef.
* Definition Classes
  * ArrowAssoc
* Annotations
  * @inline ()

(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Private,B))


 `def ensuring(cond: (Private) ⇒ Boolean): Private`
----------------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Private to Ensuring [
    Private] performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Private)⇒Boolean):Private)


 `def ensuring(cond: (Private) ⇒ Boolean, msg: ⇒ Any): Private`
----------------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Private)⇒Boolean,⇒Any):Private)


 `def ensuring(cond: Boolean): Private`
----------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Private)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Private`
----------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Private)
...
* Implicit information
  * This member is added by an implicit conversion from Private to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Private)
