...
* Implicit information
  * This member is added by an implicit conversion from Item to StringAdd
...
* Implicit information
  * This member is added by an implicit conversion from Item to ArrowAssoc [Item]
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#->[B](B):(Item,B))


 `def ensuring(cond: (Item) ⇒ Boolean): Item`
----------------------------------------------

* Implicit information
  * This member is added by an implicit conversion from Item to Ensuring [Item]
    performed by method any2Ensuring in scala.Predef.
* Definition Classes
  * Ensuring

(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Item)⇒Boolean):Item)


 `def ensuring(cond: (Item) ⇒ Boolean, msg: ⇒ Any): Item`
----------------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring((Item)⇒Boolean,⇒Any):Item)


 `def ensuring(cond: Boolean): Item`
-------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean):Item)


 `def ensuring(cond: Boolean, msg: ⇒ Any): Item`
-------------------------------------------------
...
(added by implicit convertion: scala.Predef.any2Ensuring#ensuring(Boolean,⇒Any):Item)
...
* Implicit information
  * This member is added by an implicit conversion from Item to StringFormat
...
(added by implicit convertion: scala.Predef.any2ArrowAssoc#x:Item)
